...
class ProductDetails extends StatefulWidget {
  ...
  var product;
  ProductDetails({Key? key, required this.product})
      : super(key: key);
...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  Future addToCart() async {
    ...
    return _collectionRef.doc(currentUser!.uid).collection("Items").doc().set({
      ...
      "Product-Image": widget.product["Product-Image"][0],
      "Product-Code": widget.product["Product-Code"],
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children:
                  widget.product["Product-Image"].map<Widget>((url) {
                int index =
                    widget.product["Product-Image"].indexOf(url);
                return Container(
                  width: 10,
                  height: 10,
            ...
            Text(
              "Product Color: ${widget.product["Product-Color"]}",
              style: GoogleFonts.zenKurenaido(
                fontStyle: FontStyle.normal,
                decoration: TextDecoration.none,
                fontSize: 22.sp,
            ...
            Text(
              "Product Availability: ${widget.product["Product-Availability"]}",
              style: GoogleFonts.zenKurenaido(
                fontStyle: FontStyle.normal,
                decoration: TextDecoration.none,
                fontSize: 22.sp,
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        "BDT ${widget.product["Product-Price"].toString()}",
                        style: GoogleFonts.zenKurenaido(
                          height: 1.5.h,
                          fontStyle: FontStyle.normal,
                          decoration: TextDecoration.none,
