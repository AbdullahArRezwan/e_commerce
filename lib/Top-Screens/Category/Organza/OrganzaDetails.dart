...
class OrganzaDetailsPage extends StatefulWidget {
  final DocumentSnapshot documentSnapshot;
  const OrganzaDetailsPage({Key? key, required this.documentSnapshot})
      : super(key: key);

  @override
  State<OrganzaDetailsPage> createState() => _OrganzaDetailsPageState();
}

class _OrganzaDetailsPageState extends State<OrganzaDetailsPage> {
