...
class MPDetailsPage extends StatefulWidget {
  final DocumentSnapshot documentSnapshot;
  MPDetailsPage({Key? key, required this.documentSnapshot}) : super(key: key);

  @override
  State<MPDetailsPage> createState() => _MPDetailsPageState();
}

class _MPDetailsPageState extends State<MPDetailsPage> {
  ...
  Future addToCart() async {
    ...
    return _collectionRef
        ...
        .doc()
        .set({
      "Product-Name": widget.documentSnapshot["Name"],
      "Product-Price": widget.documentSnapshot["Price"],
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
              ...
              children: [
                StreamBuilder(
                  stream: FirebaseFirestore.instance.collection("Users-Favourite-Items").doc(FirebaseAuth.instance.currentUser!.uid)
                      .collection("Items").where("Product-Name",isEqualTo: widget.documentSnapshot['Name']).snapshots(),
            ...
            Text(
              "Product Availability: ${widget.documentSnapshot["Availability"]}",
              style: GoogleFonts.zenKurenaido(
                fontStyle: FontStyle.normal,
                decoration: TextDecoration.none,
                fontSize: 22.sp,
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        "BDT ${widget.documentSnapshot["Price"].toString()}",
                        style: GoogleFonts.zenKurenaido(
                          height: 1.5.h,
                          fontStyle: FontStyle.normal,
                          decoration: TextDecoration.none,
