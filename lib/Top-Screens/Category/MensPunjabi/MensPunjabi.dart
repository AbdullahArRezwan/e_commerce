...
import 'package:e_commerce/Top-Screens/Category/MensPunjabi/MPDetailsPage.dart';
...
class _MensPunjabiState extends State<MensPunjabi> {
  ...
  //   QuerySnapshot qn =
  //       await _firestoreInstance.collection("Mens-Punjabi").get();
  //   setState(() {
  ...
  //         "image": qn.docs[i]["Product-Image"],
  //         "availability": qn.docs[i]["Availability"],
  //         "color": qn.docs[i]["Product-Color"],
  //         "code": qn.docs[i]["Product-Code"],
  //       });
  //     }
  //   });
  //   return qn.docs;
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ProductCard(
                      ...
                      onPressed: () => Navigator.of(context).push(
                          MaterialPageRoute(
                              builder: (context) => MPDetailsPage(documentSnapshot: products))),
                    );
                  },
                ),
              );
