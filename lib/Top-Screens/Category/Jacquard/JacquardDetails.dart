...
class JacquardDetails extends StatefulWidget {
  final DocumentSnapshot documentSnapshot;
  const JacquardDetails({Key? key, required this.documentSnapshot})
      : super(key: key);

  @override
  State<JacquardDetails> createState() => _JacquardDetailsState();
}

class _JacquardDetailsState extends State<JacquardDetails> {
              ...
              children: [
                StreamBuilder(
                  stream: FirebaseFirestore.instance
                      ...
                      .collection("Items")
                      .where("Product-Name",
                          isEqualTo: widget.documentSnapshot['Product-Name'])
                      .snapshots(),
