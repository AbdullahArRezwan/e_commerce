...
class ChikankariDetailsPage extends StatefulWidget {
  final DocumentSnapshot documentSnapshot;
  const ChikankariDetailsPage({Key? key, required this.documentSnapshot}) : super(key: key);

  @override
  State<ChikankariDetailsPage> createState() => _ChikankariDetailsPageState();
}

class _ChikankariDetailsPageState extends State<ChikankariDetailsPage> {
          ...
          children: [
            ...
            Text(
              "Product Availability: ${widget
                  .documentSnapshot["Product-Availability"]}",
              style: GoogleFonts.zenKurenaido(
                fontStyle: FontStyle.normal,
                decoration: TextDecoration.none,
                fontSize: 22.sp,
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        "BDT ${widget.documentSnapshot["Product-Price"]
                            .toString()}",
                        style: GoogleFonts.zenKurenaido(
                          height: 1.5.h,
                          fontStyle: FontStyle.normal,
