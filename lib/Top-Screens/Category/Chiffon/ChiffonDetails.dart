...
class ChiffonDetailsPage extends StatefulWidget {
  final DocumentSnapshot documentSnapshot;
  const ChiffonDetailsPage({Key? key, required this.documentSnapshot}) : super(key: key);

  @override
  State<ChiffonDetailsPage> createState() => _ChiffonDetailsPageState();
}

class _ChiffonDetailsPageState extends State<ChiffonDetailsPage> {
